...
type ComputeLister interface {
	...
	List(selector labels.Selector) (ret []*computev1alpha1.Compute, err error)
...
type computeLister struct {
	listers.ResourceIndexer[*computev1alpha1.Compute]
}

// NewComputeLister returns a new ComputeLister.
func NewComputeLister(indexer cache.Indexer) ComputeLister {
	return &computeLister{listers.New[*computev1alpha1.Compute](indexer, computev1alpha1.Resource("compute"))}
}

// Computes returns an object that can list and get Computes.
func (s *computeLister) Computes(namespace string) ComputeNamespaceLister {
	return computeNamespaceLister{listers.NewNamespaced[*computev1alpha1.Compute](s.ResourceIndexer, namespace)}
}
...
type ComputeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*computev1alpha1.Compute, error)
