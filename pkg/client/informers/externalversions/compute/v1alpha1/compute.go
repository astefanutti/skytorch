...
import (
	...
	apiscomputev1alpha1 "github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1"
	...
	computev1alpha1 "github.com/astefanutti/skytorch/pkg/client/listers/compute/v1alpha1"
...
type ComputeInformer interface {
	...
	Lister() computev1alpha1.ComputeLister
}
...
func (f *computeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscomputev1alpha1.Compute{}, f.defaultInformer)
}

func (f *computeInformer) Lister() computev1alpha1.ComputeLister {
	return computev1alpha1.NewComputeLister(f.Informer().GetIndexer())
}
