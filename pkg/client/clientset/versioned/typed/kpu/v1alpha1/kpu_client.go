...
// ComputeV1alpha1Client is used to interact with features provided by the compute.kpu.dev group.
type ComputeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ComputeV1alpha1Client) Computes(namespace string) ComputeInterface {
...
func setConfigDefaults(config *rest.Config) {
	gv := kpuv1alpha1.SchemeGroupVersion
