...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.Compute":                 schema_pkg_apis_compute_v1alpha1_Compute(ref),
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeAddress":          schema_pkg_apis_compute_v1alpha1_ComputeAddress(ref),
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeList":             schema_pkg_apis_compute_v1alpha1_ComputeList(ref),
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeSpec":             schema_pkg_apis_compute_v1alpha1_ComputeSpec(ref),
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeStatus":           schema_pkg_apis_compute_v1alpha1_ComputeStatus(ref),
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ContainerOverride":       schema_pkg_apis_compute_v1alpha1_ContainerOverride(ref),
		"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.PodTemplateSpecOverride": schema_pkg_apis_compute_v1alpha1_PodTemplateSpecOverride(ref),
...
func schema_pkg_apis_compute_v1alpha1_Compute(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Compute represents the configuration of a compute environment.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "metadata of the Compute.",
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "spec of the Compute.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeSpec", "github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_compute_v1alpha1_ComputeAddress(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_compute_v1alpha1_ComputeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ComputeList is a collection of computes.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.Compute"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.Compute", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_compute_v1alpha1_ComputeSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ComputeSpec represents the specification of the Compute.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"labels": {
						SchemaProps: spec.SchemaProps{
							Description: "labels to apply to the Compute resources.",
							Type:        []string{"object"},
					...
					"annotations": {
						SchemaProps: spec.SchemaProps{
							Description: "annotations to apply to the Compute resources.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"suspend": {
						SchemaProps: spec.SchemaProps{
							Description: "suspend defines whether to suspend the running Compute. Defaults to false.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"image": {
						SchemaProps: spec.SchemaProps{
							Description: "image is the container image for the Compute runtime.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"command": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "command for the entrypoint of the Compute runtime.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"args": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "args for the entrypoint for the Compute runtime.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"env": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "env is the list of environment variables to set in the Compute runtime.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_compute_v1alpha1_ComputeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ComputeStatus represents the current status of the Compute.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "conditions of the Compute.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeAddress"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ComputeAddress", "k8s.io/apimachinery/pkg/apis/meta/v1.Condition"},
	}
}

func schema_pkg_apis_compute_v1alpha1_ContainerOverride(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"env": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "env is the list of environment variables to set in the container.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_compute_v1alpha1_PodTemplateSpecOverride(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodTemplateSpecOverride represents the spec overrides for Pod template.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"serviceAccountName": {
						SchemaProps: spec.SchemaProps{
					...
					"nodeSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "nodeSelector overrides the node selector.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"affinity": {
						SchemaProps: spec.SchemaProps{
							Description: "affinity overrides for the affinity.",
					...
					"tolerations": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "tolerations overrides the tolerations.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"volumes": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "volumes overrides the volumes.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"initContainers": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "initContainers overrides the init containers.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ContainerOverride"),
									},
								},
							},
						},
					...
					"containers": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "containers overrides for the containers.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"schedulingGates": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "schedulingGates overrides the scheduling gates. More info: https://kubernetes.io/docs/concepts/scheduling-eviction/pod-scheduling-readiness/",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/astefanutti/skytorch/pkg/apis/compute/v1alpha1.ContainerOverride", "k8s.io/api/core/v1.Affinity", "k8s.io/api/core/v1.LocalObjectReference", "k8s.io/api/core/v1.PodSchedulingGate", "k8s.io/api/core/v1.Toleration", "k8s.io/api/core/v1.Volume"},
	}
}
