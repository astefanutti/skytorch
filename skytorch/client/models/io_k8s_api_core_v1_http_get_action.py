...
from skytorch.client.models.io_k8s_api_core_v1_http_header import IoK8sApiCoreV1HTTPHeader
from skytorch.client.models.io_k8s_apimachinery_pkg_util_intstr_int_or_string import IoK8sApimachineryPkgUtilIntstrIntOrString
